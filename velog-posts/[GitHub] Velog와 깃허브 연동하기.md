...
<p>1일 1잔디, 부지런히 채워보자 ★</p>
<p>✔️ <a href="https://api.velog.io/rss/@iamsuuya#link1"><u>게시글 맨 하단에 기여자 내 계정으로 바꾸는 방법 추가했습니다.</u></a>
<br /><br /></p>
...
<h2 id="✅-결과-🌴🌲🌳">✅ 결과 🌴🌲🌳</h2>
<p>정상적으로 반영된 화면<img alt="" src="https://velog.velcdn.com/images/iamsuuya/post/b20c6fdd-45ac-465d-9aee-19d2f84ef490/image.png" /><br /></p>
<h2 id="✅-자동-커밋-했는데-왜-기여-기록이-안-보일까-😾">✅ 자동 커밋 했는데... 왜 기여 기록이 안 보일까? 😾</h2>
<p>위와 같이 설정을 마치고 꾸준히 블로그를 쓰다가 . . .
한 달이 지난 지금 그동안 작성해온 블로그 커밋 기록이 잔디에 하나도 쌓이지 않았음을 알게 되었다......!!!!!!!!!11!</p>
<p>모든 블로그를 찾아봐도 위와 같은 방법으로 설명하고 ^잔디 심는 법^이라고 소개하고 있는데 말이죠... 🦭</p>
<p>(나만 이런 문제가 있는 걸까?)
<br /></p>
<p>그래서 해당 이슈를 지피티에 물어보니까 
<img alt="" src="https://velog.velcdn.com/images/iamsuuya/post/018f6ae8-f47c-4923-98fd-c78e3082c956/image.png" /></p>
<p>라고 설명해줬다. 
<br /><br /></p>
<p>그동안 재주는 내가 부리고 기여는 봇이하고 있었단 말이지</p>
<img src="https://velog.velcdn.com/images/iamsuuya/post/49a33825-19cd-4e8f-9cd9-6fbaa9cdf266/image.png" width="200" />


<br />

<h3 id="div-idlink1해결-방법div"><div id="link1">해결 방법</div></h3>
<p>✔️ Push 단계에서 author를 본인으로 변경</p>
<p>📄 <strong>update_blog.yml</strong></p>
<p>이 부분을 ..</p>
...
<p>아래와 같이 변경하면 된다.
이메일은 반드시 GitHub 내 본인 계정에 등록된 이메일이어야한다.</p>
<pre><code class="language-yaml">git config --global user.name '1. 깃허브 계정 아이디'
git config --global user.email '2. GitHub에서 제공하는 noreply 이메일'</code></pre>
<p>🌠** GitHub에서 제공하는 noreply 이메일 확인 방법**
GitHub Settings &gt; Emails &gt; &quot;Keep my email addresses private&quot; 버튼 활성화 한 뒤, 거기에서 <code><a href="mailto:12345678+suuuuya@users.noreply.github.com">12345678+suuuuya@users.noreply.github.com</a></code> 같은 형태의 주소 확인 가능
<br /></p>
<hr />
<h2 id="참고자료">참고자료</h2>
